...
newParagraph.innerText = 'Mary is lit!';
...
hoverChangeCssStyleProp(footer, 'backgroundColor', 'purple', '#39add1');
...
function hoverChangeCssStyleProp(element, cssProp, value1, value2) {
